...
enum {
    ...
    OR_COLOR_DARK_BLUE     = 0x0B3D91,
    OR_COLOR_BLUE          = 0x2196F3,
    OR_COLOR_LIGHT_BLUE    = 0xBBDEFB,
    OR_COLOR_TEXT          = 0xFFFFFF,
    OR_COLOR_FIRE_RED      = 0xD32F2F,
    OR_COLOR_FIRE_ORANGE   = 0xF57C00,
    OR_COLOR_FIRE_YELLOW   = 0xFBC02D,
    OR_COLOR_TEXT_DIM_BLUE = 0x0D47A1,
    OR_COLOR_TEXT_DIM_GOLD = 0xCC9707
};
